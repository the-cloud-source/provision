...
network  --hostname=iron.home.lan

url                   --url=https://mirrors.ptisp.pt/fedora/linux/releases/36/Everything/x86_64/os/
repo --name="upd" --baseurl=https://mirrors.ptisp.pt/fedora/linux/updates/36/Everything/x86_64/
